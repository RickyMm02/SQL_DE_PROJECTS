# Data Warehouse & Mart Build: Production ETL
...
- **SQL Files:**
  - [`create_tables_dw.sql`](./create_tables_dw.sql) – Defines star schema with 4 core tables
  - [`load_schema_dw.sql`](./load_schema_dw.sql) – Extracts CSVs from GCS and loads into warehouse tables
...
![Flat Mart Schema](../Images/Flat_Mart.png)

- **SQL File:** [`create_flat_mart.sql`](./create_flat_mart.sql) – Builds denormalized table with all dimensions joined
...
![Skills Mart Schema](../Images/Skills_Mart.png)

- **SQL File:** [`create_skills_mart.sql`](./create_skills_mart.sql) – Builds time-series skill demand mart
...
![Priority Mart Schema](../Images/Priority_Mart.png)

- **SQL Files:**
  - [`create_priority_mart.sql`](./05_create_priority_mart.sql) – Initial build of priority roles and jobs snapshot
...
## Data Engineering Skills Demonstated
